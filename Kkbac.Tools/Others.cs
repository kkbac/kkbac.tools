...
namespace Kkbac.Tools
{
    ...
    {
        /// <summary>
        /// smalldatetime记录的时间范围较短，1900-01-01到2079-6-6，只能到精确到“分”，它的长度为4位，所占的空间较小。
        /// </summary>
        public static DateTime MsSqlSmallDatetimeMin = new DateTime(1900, 1, 1);
        /// <summary>
        /// smalldatetime记录的时间范围较短，1900-01-01到2079-6-6，只能到精确到“分”，它的长度为4位，所占的空间较小。
        /// </summary>
        public static DateTime MsSqlSmallDatetimeMax = new DateTime(2079, 6, 6);
        ...
        /// <returns></returns>
        public static string DateDiffString(DateTime DateTimeOld)
        {
            return DateDiffString(DateTimeOld, DateTime.Now);
        }
        ...
        /// </summary>
        /// <param name="DateTimeOld">较早的日期和时间</param>
        /// <param name="DateTimeNew">较新的日期和时间</param>
        /// <returns></returns>
        public static string DateDiffString(DateTime DateTimeOld, DateTime DateTimeNew)
        {
            string dateDiff = "";
            //TimeSpan ts1 = new TimeSpan(DateTimeOld.Ticks);
            //TimeSpan ts2 = new TimeSpan(DateTimeNew.Ticks);
            //TimeSpan ts = ts1.Subtract(ts2).Duration();
            var ts = DateTimeNew - DateTimeOld;
            int day = ts.Days;
            int hou = ts.Hours;
            int minu = ts.Minutes;
            int sec = ts.Seconds;
        ...
        /// <returns></returns>
        public static string GetFileMimeType(string strFileName)
        {
            string retval = "";
        ...
        public static string Base64Encrypt(string sourthUrl)
        {
            ...
            eurl = Convert.ToBase64String(System.Text.Encoding.Default.GetBytes(eurl));
            return eurl;
        }
        #endregion
        ...
        public static string Base64Decrypt(string eStr)
        {
            ...
            string sourthUrl = System.Text.Encoding.Default.GetString(buffer);
